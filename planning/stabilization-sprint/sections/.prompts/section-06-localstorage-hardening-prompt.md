...
Generate content for section `section-06-localstorage-hardening` (filename: `section-06-localstorage-hardening.md`).
...
for `section-06-localstorage-hardening` to understand what this section should contain.
...
`C:\GrowDoc\planning\stabilization-sprint/sections/section-06-localstorage-hardening.md`
