...
Generate content for section `section-03-cultivation-contradictions` (filename: `section-03-cultivation-contradictions.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\GrowDoc\planning\stabilization-sprint/claude-plan.md` - Full implementation plan
2. `C:\GrowDoc\planning\stabilization-sprint/claude-plan-tdd.md` - Test stubs for each section
3. `C:\GrowDoc\planning\stabilization-sprint/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-cultivation-contradictions` to understand what this section should contain.
...
`C:\GrowDoc\planning\stabilization-sprint/sections/section-03-cultivation-contradictions.md`
