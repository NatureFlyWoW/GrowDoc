...
Generate content for section `section-07-service-worker-cache` (filename: `section-07-service-worker-cache.md`).
...
for `section-07-service-worker-cache` to understand what this section should contain.
...
`C:\GrowDoc\planning\stabilization-sprint/sections/section-07-service-worker-cache.md`
