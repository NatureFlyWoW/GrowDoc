...
Generate content for section `section-02-error-handling` (filename: `section-02-error-handling.md`).
...
for `section-02-error-handling` to understand what this section should contain.
...
`C:\GrowDoc\planning\stabilization-sprint/sections/section-02-error-handling.md`
