...
Generate content for section `section-03-stealth-audit` (filename: `section-03-stealth-audit.md`).
...
for `section-03-stealth-audit` to understand what this section should contain.
...
`C:\GrowDoc\planning\interactive-tools/sections/section-03-stealth-audit.md`
