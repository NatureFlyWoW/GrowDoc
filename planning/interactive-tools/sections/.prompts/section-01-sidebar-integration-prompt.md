...
Generate content for section `section-01-sidebar-integration` (filename: `section-01-sidebar-integration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\GrowDoc\planning\interactive-tools/claude-plan.md` - Full implementation plan
2. `C:\GrowDoc\planning\interactive-tools/claude-plan-tdd.md` - Test stubs for each section
3. `C:\GrowDoc\planning\interactive-tools/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-01-sidebar-integration` to understand what this section should contain.
...
`C:\GrowDoc\planning\interactive-tools/sections/section-01-sidebar-integration.md`
