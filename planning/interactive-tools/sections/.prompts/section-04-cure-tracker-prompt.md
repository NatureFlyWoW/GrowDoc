...
Generate content for section `section-04-cure-tracker` (filename: `section-04-cure-tracker.md`).
...
for `section-04-cure-tracker` to understand what this section should contain.
...
`C:\GrowDoc\planning\interactive-tools/sections/section-04-cure-tracker.md`
