...
Generate content for section `section-02-env-dashboard` (filename: `section-02-env-dashboard.md`).
...
for `section-02-env-dashboard` to understand what this section should contain.
...
`C:\GrowDoc\planning\interactive-tools/sections/section-02-env-dashboard.md`
