...
Generate content for section `section-05-plant-doctor` (filename: `section-05-plant-doctor.md`).
...
for `section-05-plant-doctor` to understand what this section should contain.
...
`C:\GrowDoc\planning\interactive-tools/sections/section-05-plant-doctor.md`
