...
Generate content for section `section-16-knowledge-base` (filename: `section-16-knowledge-base.md`).
...
for `section-16-knowledge-base` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-16-knowledge-base.md`
