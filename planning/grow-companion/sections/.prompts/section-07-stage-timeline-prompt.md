...
Generate content for section `section-07-stage-timeline` (filename: `section-07-stage-timeline.md`).
...
for `section-07-stage-timeline` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-07-stage-timeline.md`
