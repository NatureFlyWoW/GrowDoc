...
Generate content for section `section-02-store-storage` (filename: `section-02-store-storage.md`).
...
for `section-02-store-storage` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-02-store-storage.md`
