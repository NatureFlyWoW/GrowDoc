...
Generate content for section `section-03-landing-onboarding` (filename: `section-03-landing-onboarding.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\GrowDoc\planning\grow-companion/claude-plan.md` - Full implementation plan
2. `C:\GrowDoc\planning\grow-companion/claude-plan-tdd.md` - Test stubs for each section
3. `C:\GrowDoc\planning\grow-companion/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-landing-onboarding` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-03-landing-onboarding.md`
