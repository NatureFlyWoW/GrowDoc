...
Generate content for section `section-15-plant-doctor` (filename: `section-15-plant-doctor.md`).
...
for `section-15-plant-doctor` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-15-plant-doctor.md`
