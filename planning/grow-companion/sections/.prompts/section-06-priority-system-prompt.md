...
Generate content for section `section-06-priority-system` (filename: `section-06-priority-system.md`).
...
for `section-06-priority-system` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-06-priority-system.md`
