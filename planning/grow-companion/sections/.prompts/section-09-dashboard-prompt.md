...
Generate content for section `section-09-dashboard` (filename: `section-09-dashboard.md`).
...
for `section-09-dashboard` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-09-dashboard.md`
