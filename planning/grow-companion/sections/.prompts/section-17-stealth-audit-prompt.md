...
Generate content for section `section-17-stealth-audit` (filename: `section-17-stealth-audit.md`).
...
for `section-17-stealth-audit` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-17-stealth-audit.md`
