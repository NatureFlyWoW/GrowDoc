...
Generate content for section `section-18-settings-data` (filename: `section-18-settings-data.md`).
...
for `section-18-settings-data` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-18-settings-data.md`
