...
Generate content for section `section-10-environment` (filename: `section-10-environment.md`).
...
for `section-10-environment` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-10-environment.md`
