...
Generate content for section `section-01-app-shell` (filename: `section-01-app-shell.md`).
...
for `section-01-app-shell` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-01-app-shell.md`
