...
Generate content for section `section-05-strain-database` (filename: `section-05-strain-database.md`).
...
for `section-05-strain-database` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-05-strain-database.md`
