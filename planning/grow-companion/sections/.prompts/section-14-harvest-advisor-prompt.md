...
Generate content for section `section-14-harvest-advisor` (filename: `section-14-harvest-advisor.md`).
...
for `section-14-harvest-advisor` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-14-harvest-advisor.md`
