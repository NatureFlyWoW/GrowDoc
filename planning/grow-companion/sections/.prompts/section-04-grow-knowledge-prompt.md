...
Generate content for section `section-04-grow-knowledge` (filename: `section-04-grow-knowledge.md`).
...
for `section-04-grow-knowledge` to understand what this section should contain.
...
`C:\GrowDoc\planning\grow-companion/sections/section-04-grow-knowledge.md`
