...
Generate content for section `section-01-knowledge-base` (filename: `section-01-knowledge-base.md`).
...
for `section-01-knowledge-base` to understand what this section should contain.
...
`C:\GrowDoc\planning\plant-doctor-v2/sections/section-01-knowledge-base.md`
