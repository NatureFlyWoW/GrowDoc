...
Generate content for section `section-06-treatment-journal` (filename: `section-06-treatment-journal.md`).
...
for `section-06-treatment-journal` to understand what this section should contain.
...
`C:\GrowDoc\planning\plant-doctor-v2/sections/section-06-treatment-journal.md`
