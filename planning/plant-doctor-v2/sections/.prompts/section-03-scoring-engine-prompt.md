...
Generate content for section `section-03-scoring-engine` (filename: `section-03-scoring-engine.md`).
...
for `section-03-scoring-engine` to understand what this section should contain.
...
`C:\GrowDoc\planning\plant-doctor-v2/sections/section-03-scoring-engine.md`
