...
Generate content for section `section-04-notes-input` (filename: `section-04-notes-input.md`).
...
for `section-04-notes-input` to understand what this section should contain.
...
`C:\GrowDoc\planning\plant-doctor-v2/sections/section-04-notes-input.md`
