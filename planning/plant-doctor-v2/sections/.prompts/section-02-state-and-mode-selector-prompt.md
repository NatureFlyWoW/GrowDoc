...
Generate content for section `section-02-state-and-mode-selector` (filename: `section-02-state-and-mode-selector.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\GrowDoc\planning\plant-doctor-v2/claude-plan.md` - Full implementation plan
2. `C:\GrowDoc\planning\plant-doctor-v2/claude-plan-tdd.md` - Test stubs for each section
3. `C:\GrowDoc\planning\plant-doctor-v2/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-state-and-mode-selector` to understand what this section should contain.
...
`C:\GrowDoc\planning\plant-doctor-v2/sections/section-02-state-and-mode-selector.md`
