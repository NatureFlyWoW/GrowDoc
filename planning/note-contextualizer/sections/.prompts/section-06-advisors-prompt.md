...
Generate content for section `section-06-advisors` (filename: `section-06-advisors.md`).
...
for `section-06-advisors` to understand what this section should contain.
...
`C:\GrowDoc\planning\note-contextualizer/sections/section-06-advisors.md`
