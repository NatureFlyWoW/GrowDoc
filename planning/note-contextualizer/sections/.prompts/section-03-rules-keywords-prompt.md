...
Generate content for section `section-03-rules-keywords` (filename: `section-03-rules-keywords.md`).
...
for `section-03-rules-keywords` to understand what this section should contain.
...
`C:\GrowDoc\planning\note-contextualizer/sections/section-03-rules-keywords.md`
