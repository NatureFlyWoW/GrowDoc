...
Generate content for section `section-08-ui-finalization` (filename: `section-08-ui-finalization.md`).
...
for `section-08-ui-finalization` to understand what this section should contain.
...
`C:\GrowDoc\planning\note-contextualizer/sections/section-08-ui-finalization.md`
