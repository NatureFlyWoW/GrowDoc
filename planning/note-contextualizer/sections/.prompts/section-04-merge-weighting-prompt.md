...
Generate content for section `section-04-merge-weighting` (filename: `section-04-merge-weighting.md`).
...
for `section-04-merge-weighting` to understand what this section should contain.
...
`C:\GrowDoc\planning\note-contextualizer/sections/section-04-merge-weighting.md`
