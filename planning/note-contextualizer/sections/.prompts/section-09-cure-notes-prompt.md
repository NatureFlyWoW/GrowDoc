...
Generate content for section `section-09-cure-notes` (filename: `section-09-cure-notes.md`).
...
for `section-09-cure-notes` to understand what this section should contain.
...
`C:\GrowDoc\planning\note-contextualizer/sections/section-09-cure-notes.md`
