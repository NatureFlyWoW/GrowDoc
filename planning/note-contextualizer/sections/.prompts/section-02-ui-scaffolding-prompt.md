...
Generate content for section `section-02-ui-scaffolding` (filename: `section-02-ui-scaffolding.md`).
...
for `section-02-ui-scaffolding` to understand what this section should contain.
...
`C:\GrowDoc\planning\note-contextualizer/sections/section-02-ui-scaffolding.md`
