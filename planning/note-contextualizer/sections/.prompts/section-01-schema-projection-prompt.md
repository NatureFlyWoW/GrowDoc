...
Generate content for section `section-01-schema-projection` (filename: `section-01-schema-projection.md`).
...
for `section-01-schema-projection` to understand what this section should contain.
...
`C:\GrowDoc\planning\note-contextualizer/sections/section-01-schema-projection.md`
